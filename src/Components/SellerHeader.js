...
import Residential from '../Screens/ModalButtons/SellerResidential';
import Commersial from '../Screens/ModalButtons/SellerCommersial';
import Industial from '../Screens/ModalButtons/SellerIndustry';
import Agricultural from '../Screens/ModalButtons/SellerAgri';
import AdminHome from '../Screens/Seller/SellerHome';
import Viewstate from '../Screens/ModalButtons/SellerViewState';
import About from '../Screens/ModalButtons/SellerAbout';
import FAQ from '../Screens/ModalButtons/SellerFaq';
import Suggestion from '../Screens/ModalButtons/SellerSuggestion';
import Viewbanks from '../Screens/ModalButtons/SellerBank';
import Notification from '../Screens/UserModal/SellerNotification';
import ResetPass from '../Screens/UserModal/SellerResetPass';
    ...
    return(
        <View style={styles.header}>
            ...
            <View style={{flexDirection:'row',alignItems: 'center',justifyContent: 'space-between',bottom:40}}>
                  ...
                  <TouchableOpacity  style={{right:80}} onPress={() => setModalOpen(false)} >
            ...
            <View style={styles.centeredView2}>
                  ...
                  <Text style={{fontSize:20,color:colors.secondary,fontWeight:'bold',left:40}} >Hi,Jeck</Text>
                    
                 </View>

                 <TouchableOpacity  style={{left:70}} >
                        <AntDesign onPress={ () => setModalUserOpen(false)} style={styles.optionButton} name="right" size={25} color={colors.secondary}/>
                    </TouchableOpacity>
            ...
            <Modal
             ...
             <View><AntDesign  onPress={()=> setModalOpen(true)} style={styles.iconItem} name="menu-fold" size ={30}></AntDesign></View>
            <View><Text style={styles.title} title="Hi Joe">{text} </Text></View>
            <View><FontAwesome onPress={()=> setModalUserOpen(true)} style={styles.iconItem}  name="user-circle" size ={35}></FontAwesome ></View>
