...
export default function SellerHeaderBank({text}){
    ...
    return(
        ...
        <View style={styles.header}>
            ...
            {/* disclamer modal */}
             ...
             <View><FontAwesome onPress={()=> setModalOpenHome(true)} style={styles.iconItem}  name="chevron-left" size ={24}></FontAwesome ></View>
