...
export default function SellernotifiHeader({text}){
    ...
    return(
        ...
        <View style={styles.header}>
            ...
            {/* disclamer modal */}
             ...
             <View><FontAwesome onPress={()=> setModalOpenHome(true)} style={styles.iconItem}  name="chevron-left" size ={22}></FontAwesome ></View>
